...
def main():
    ...
    experiment_ls = ["clean/exp_resnet_clean_0.0"]+[f"cutout{pretrain_str}/exp_resnet_cutout_patch_size_{c}_{s}" for c in [20.0, 30.0, 50.0, 80.0] for s in [0.2, 0.3, 0.5, 0.8]]
